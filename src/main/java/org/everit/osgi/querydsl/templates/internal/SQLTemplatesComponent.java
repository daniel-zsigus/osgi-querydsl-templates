...
@Properties({
    @Property(name = SQLTemplatesConstants.PROP_DB_TYPE, value = DBMSType.TYPE_H2,
            options = {
            @PropertyOption(name = DBMSType.TYPE_H2,
                    value = DBMSType.TYPE_H2),
                    @PropertyOption(name = DBMSType.TYPE_POSTGRES,
                    value = DBMSType.TYPE_POSTGRES),
                    @PropertyOption(name = DBMSType.TYPE_MYSQL,
                    value = DBMSType.TYPE_MYSQL),
                    @PropertyOption(name = DBMSType.TYPE_ORACLE,
                    value = DBMSType.TYPE_ORACLE),
                    @PropertyOption(name = DBMSType.TYPE_SQLITE,
                    value = DBMSType.TYPE_SQLITE),
                    @PropertyOption(name = DBMSType.TYPE_CUBRID,
                    value = DBMSType.TYPE_CUBRID),
                    @PropertyOption(name = DBMSType.TYPE_DERBY,
                    value = DBMSType.TYPE_DERBY),
                    @PropertyOption(name = DBMSType.TYPE_HSQLDB,
                    value = DBMSType.TYPE_HSQLDB),
                    @PropertyOption(name = DBMSType.TYPE_TERADATA,
                    value = DBMSType.TYPE_TERADATA),
                    @PropertyOption(name = DBMSType.TYPE_SQLSERVER,
                    value = DBMSType.TYPE_SQLSERVER),
                    @PropertyOption(name = DBMSType.TYPE_SQLSERVER_2005,
                    value = DBMSType.TYPE_SQLSERVER_2005),
                    @PropertyOption(name = DBMSType.TYPE_SQLSERVER_2008,
                    value = DBMSType.TYPE_SQLSERVER_2008),
                    @PropertyOption(name = DBMSType.TYPE_SQLSERVER_2012,
